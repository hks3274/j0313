...
public class Test1 {
	public static void main(String[] args) {
		...
		System.out.println("2. objSu1 + 100 : "+(objSu1 +100)); //객체변환만 된거 속성은 변하지 않는다 
		
		//자동박싱 처리의 예
		Integer objSu2; 
		objSu2 = intSu2;
		System.out.println("2. objSu1 + 100 : "+(objSu2 +100)); //객체변환만 된거 속성은 변하지 않는다 
		
		//unBoxing처리
		String strIntSu1 = "100";
		System.out.println("strIntSu1 + 100 = "+ (strIntSu1+100));
		System.out.println("strIntSu1 + 100 = "+ (Integer.parseInt(strIntSu1)+100)); //언박싱
		
		//double <-> Double
		double dblSu = 3.14;
		Double objDblSu = new Double(dblSu);
		System.out.println("2.objDblSu + 100 = "+ (objDblSu +100.5));
		
		//Boxing
		int su2 = 100;
		Integer objSu3 =  Integer.valueOf(su2);
